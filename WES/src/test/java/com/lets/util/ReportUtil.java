...
import com.lets.test.Constants;
...
public class ReportUtil {
    ...
    public static void main(String[] arg) throws Exception {
        ...
        FileInputStream fs = new FileInputStream(System.getProperty("user.dir")+"//src//test//java//com//lets//config//config.properties");
        Properties CONFIG= new Properties();
        CONFIG.load(fs);
        String environment=CONFIG.getProperty("environment");
        String release=CONFIG.getProperty("release");
        Xls_Reader suiteXLS = new Xls_Reader(System.getProperty("user.dir")+"//src//test//java//com//lets//xls//Suite.xlsx");
        ...
        try{
            ...
            for(int currentSuiteID =2;currentSuiteID<= totalTestSuites;currentSuiteID++){
                ...
                current_suite_xls=new Xls_Reader(System.getProperty("user.dir")+"//src//test//java//com//lets//xls//"+currentTestSuite+".xlsx");
